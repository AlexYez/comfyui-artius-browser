...
class TSAudioHandler:
    ...
    def TSBuildIndexedPayload(self, ts_asset_stat: TSAssetStat, ts_asset_hash: str) -> TSAssetPayload:
        ...
        ts_probe, ts_preview_path = self.ts_preview_cache.TSGenerateWaveformPreviewParallel(
    ...
    def TSGeneratePreview(self, ts_row) -> str:
        ...
        return self.ts_preview_cache.TSGenerateWaveformPreview(ts_row["path"], ts_preview_key, self.ts_tools)
